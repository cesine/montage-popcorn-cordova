...
BUNDLE = [
	["index.html.bundle-1-0.js", "index.html.bundle-1-1.js", "index.html.bundle-1-2.js", "index.html.bundle-1-3.js"]
], typeof window != "undefined" && (document._montageTiming = {}, document._montageTiming.loadStartTime = Date.now(), window.addEventListener("DOMContentLoaded", function() {
	var e = 1e3;
			...
			return e.factory = function(e, t, s) {
				...
				for (var o in t) {
					...
					if (u instanceof Object)
						if (u.hasOwnProperty("_montage_metadata") && !u._montage_metadata.isInstance) u._montage_metadata.aliases.push(o), u._montage_metadata.objectName = o;
						else
					if (!Object.isSealed(u)) {
	...
	var o = {
		...
		getParams: function() {
			...
			if (!this._params) {
				...
				for (e = 0; e < u.length; e++) {
					...
					if (i) {
						if (r.dataset)
							for (o in r.dataset) this._params[o] = r.dataset[o];
						else if (r.attributes)
							for (t = 0; t < r.attributes.length; t++) s = r.attributes[t], n = s.name.match(/^data-(.*)$/), n && (this._params[n[1]] = s.value);
		...
		bootstrap: function(e) {
			...
			if (typeof BUNDLE == "undefined") {
				var d = h(window.location, c.montageLocation);
				for (var v in p) o.load(h(d, p[v]))
			}
			var m = {};
		...
		initMontage: function(e, t, n) {
			var r = ["core/event/event-manager", "core/deserializer", "core/logger"];
			typeof window != "undefined" && r.push("core/event/binding");
			var i = e("core/promise").Promise;
			return i.all(r.map(e.deepLoad)).then(function() {
				r.forEach(e);
				var s = e("core/event/event-manager").EventManager,
					o = e("core/deserializer").Deserializer,
					u = e("core/logger").logger,
					a, f;
				u("Promise stacktrace support", function(e) {
					i.longStackJumpLimit = e ? 1 : 0
				}), a = s.create().initWithWindow(window), typeof global.montageWillLoad == "function" && global.montageWillLoad();
				var l = t.packageDescription.applicationPrototype,
					c, h;
				return l ? (c = o.parseForModuleAndName(l), h = t.async(c.module)) : h = e.async("ui/application"), h.then(function(e) {
					f = e[c ? c.name : "Application"].create(), window.document.application = f, a.application = f, f.eventManager = a, f._load(t, function() {
...
function(e) {
	...
	function configurePackage(e, t, n) {
		...
		r.name = t.name, r.location = e || Require.getLocation(), r.packageDescription = t, r.useScriptInjection = t.useScriptInjection, t.production !== void 0 && (r.production = t.production);
		...
		var c = t.mappings || {};
		return [t.dependencies, r.production ? null : t.devDependencies].forEach(function(e) {
			if (!e) return;
	...
	Require.makeRequire = function(e) {
		...
		function i(e, n) {
			var r = t(e);
			if (r.id !== e) throw new Error("Can't require module " + JSON.stringify(r.id) + " by alternate spelling " + JSON.stringify(e));
			if (r.error) {
				var s = new Error("Can't require module " + JSON.stringify(r.id) + " via " + JSON.stringify(n) + " because " + r.error.message);
				throw s.cause = r.error, s
			}
			...
			var u = r.factory.call(void 0, o(e), r.exports, r);
			return u !== void 0 && (r.exports = u), r.exports
		}
		...
		function o(o) {
			...
			}, u.injectMapping = function(t, n) {
				t = normalizeDependency(t, e, n), n = n || t.name, e.mappings[n] = t
			}, u.injectDependency = function(e) {
				u.injectMapping({
					name: e
				}, e)
		...
		return e.mappings = e.mappings || {}, e.name = e.name,

		function(n, r) {
			var i = e.mappings,
				s = Object.keys(i),
				o = s.length;
			if (Require.isAbsolute(n)) return t(n, r);
			e.name !== void 0 && n.indexOf(e.name) === 0 && n.charAt(e.name.length) === "/" && console.warn("Package reflexive module ignored:", n);
			var u, a;
			for (u = 0; u < o; u++) {
				a = s[u];
				if (n === a || n.indexOf(a) === 0 && n.charAt(a.length) === "/") {
					var f = i[a],
						l = n.slice(a.length + 1);
					return e.loadPackage(f, e).then(function(t) {
						return r.mappingRedirect = l, r.mappingRequire = t, t.deepLoad(l, e.location)
					})
				}
			}
			return t(n, r)
	...
	Require.getLocation = function() {
		...
		function n() {
			i.reject(new Error("Can't XHR " + JSON.stringify(e)))
		}
	...
	Require.loadPackageDescription = function(e, t) {
		if (e.hash) {
			var n = getDefinition(e.hash, "package.json").promise;
			return t.preloaded.isPending() && t.preloaded.then(function(t) {
				if (n.isPending()) {
					var r = URL.resolve(e.location, "package.json.load.js");
					Require.loadScript(r)
				}
			}).done(), n.get("exports")
		}
		return loadPackageDescription(e, t)
...
function(e) {
	...
	function t(e) {
		return ot(e) === "[object StopIteration]" || e instanceof ut
	}

	function n(e, t) {
		t.stack && typeof e == "object" && e !== null && e.stack && e.stack.indexOf(at) === -1 && (e.stack = r(e.stack) + "\n" + at + "\n" + r(t.stack))
	}
	...
	function o() {
		if (Error.captureStackTrace) {
			...
			}, (new Error).stack, Error.prepareStackTrace = n, Q = e, t
		}
	}
	...
	function a() {
		function e(e) {
			if (!t) return;
			r = w(e), et(t, function(e, t) {
				Y(function() {
					r.promiseDispatch.apply(r, t)
				})
		...
		var t = [],
			...
			r, i = rt(a.prototype),
			s = rt(l.prototype);
		return s.promiseDispatch = function(e, i, s) {
			var o = Z(arguments);
			t ? (t.push(o), i === "when" && s[1] && n.push(s[1])) : Y(function() {
			...
			var e = c(r);
			return h(e) && (r = e), e
		}, Error.captureStackTrace && u.longStackJumpLimit > 0 && (Error.captureStackTrace(s, a), s.stack = s.stack.substring(s.stack.indexOf("\n") + 1)), i.promise = s, i.resolve = e, i.fulfill = function(t) {
			e(b(t))
		}, i.reject = function(t) {
			e(y(t))
		}, i.notify = function(e) {
	...
	function f(e) {
		var t = a();
		return _(e, t.resolve, t.reject, t.notify).fail(t.reject), t.promise
	}

	function l(e, t, n, r, i) {
		t === void 0 && (t = function(e) {
			return y(new Error("Promise does not support operation: " + e))
		});
		var s = rt(l.prototype);
		return s.promiseDispatch = function(n, r, i) {
			var o;
			try {
				e[r] ? o = e[r].apply(s, i) : o = t.call(s, r, i)
			} catch (u) {
				o = y(u)
			}
			n && n(o)
		}, n && (s.valueOf = n), i && (s.exception = r), s
	}
	...
	function h(e) {
		return e && typeof e.promiseDispatch == "function"
	}
	...
	function m(e) {
		return e = c(e), h(e) && "exception" in e
	}

	function g() {
		!ct && typeof window != "undefined" && !window.Touch && window.console && console.log("Should be empty:", lt), ct = !0
	}
	...
	function y(e) {
		var t = l({
			when: function(t) {
				if (t) {
					var n = tt(ft, this);
					n !== -1 && (lt.splice(n, 1), ft.splice(n, 1))
				}
				return t ? t(e) : this
			}
		}, function() {
		...
		return g(), ft.push(t), lt.push(e), t
	}
	...
	function w(e) {
		return h(e) ? e : (e = c(e), p(e) ? E(e) : b(e))
	}
	...
	function k(e) {
		return function() {
			return T([this, P(arguments)], function(t, n) {
				return e.apply(t, n)
			})
		}
	}
	...
	function L(e, t, n) {
		var r = a();
		return Y(function() {
			w(e).promiseDispatch(r.resolve, t, n)
		}), r.promise
	}
	...
	function H(e) {
		return x(e, function(e) {
			return e = nt(e, w), x(P(nt(e, function(e) {
				return x(e, G, G)
			})), function() {
				return e
			})
	...
	function I(e, t, r, i) {
		var s = function(t) {
			Y(function() {
				n(t, e);
				if (!u.onerror) throw t;
				u.onerror(t)
			})
		}, o = t || r || i ? x(e, t, r, i) : e;
		typeof process == "object" && process && process.domain && (s = process.domain.bind(s)), B(o, s)
	}
	...
	function R(e, t) {
		...
		var n = a();
		return x(e, undefined, undefined, n.notify), setTimeout(function() {
			n.resolve(e)
		}, t), n.promise
	}
	...
	function U(e, t) {
		var n = Z(t),
			r = a();
		return n.push(r.makeNodeResolver()), M(e, n).fail(r.reject), r.promise
	}

	function z(e) {
		var t = Z(arguments, 1),
			n = a();
		return t.push(n.makeNodeResolver()), M(e, t).fail(n.reject), n.promise
	}
	...
	function X(e, t) {
		...
		return function() {
			...
			var i = n.concat(Z(arguments)),
				s = a();
			return i.push(s.makeNodeResolver()), M(r, i).fail(s.reject), s.promise
		}
	}
	...
	function V(e, t, n) {
		var r = Z(n || []),
			i = a();
		return r.push(i.makeNodeResolver()), ht(e, t, r).fail(i.reject), i.promise
	}

	function $(e, t) {
		var n = Z(arguments, 2),
			r = a();
		return n.push(r.makeNodeResolver()), ht(e, t, n).fail(r.reject), r.promise
	}
	...
	var K = o(),
		Q, G = function() {}, Y;
	typeof process != "undefined" ? Y = process.nextTick : typeof setImmediate == "function" ? typeof window != "undefined" ? Y = setImmediate.bind(window) : Y = setImmediate : function() {
		function e() {
			--i;
			if (++o >= r) {
				o = 0, r *= 4;
				var e = s && Math.min(s - 1, r);
				while (i < e)++i, u()
			}
			while (s) {
				--s, t = t.next;
		...
		if (typeof MessageChannel != "undefined") {
			...
			a.port1.onmessage = e, u = function() {
	...
	var Z = e(Array.prototype.slice),
		et = e(Array.prototype.reduce || function(e, t) {
			var n = 0,
				r = this.length;
		...
		tt = e(Array.prototype.indexOf || function(e) {
			for (var t = 0; t < this.length; t++)
				if (this[t] === e) return t;
			return -1
		}),
		nt = e(Array.prototype.map || function(e, t) {
			var n = this,
				r = [];
			return et(n, function(i, s, o) {
				r.push(e.call(t, s, o, n))
			}, void 0), r
		}),
		rt = Object.create || function(e) {
			function t() {}
			return t.prototype = e, new t
		}, it = e(Object.prototype.hasOwnProperty),
		st = Object.keys || function(e) {
			var t = [];
			for (var n in e) it(e, n) && t.push(n);
			return t
		}, ot = e(Object.prototype.toString),
		ut;
	typeof ReturnValue != "undefined" ? ut = ReturnValue : ut = function(e) {
		this.value = e
	}, u.longStackJumpLimit = 1;
	var at = "From previous event:";
	u.nextTick = Y, u.defer = a, a.prototype.makeNodeResolver = function() {
		var e = this;
		return function(t, n) {
			t ? e.reject(t) : arguments.length > 2 ? e.resolve(Z(arguments, 1)) : e.resolve(n)
		}
	}, u.promise = f, u.makePromise = l, l.prototype.then = function(e, t, n) {
		return x(this, e, t, n)
	}, l.prototype.thenResolve = function(e) {
	...
	}, et(["isFulfilled", "isRejected", "isPending", "dispatch", "when", "spread", "get", "put", "set", "del", "delete", "post", "send", "invoke", "keys", "fapply", "fcall", "fbind", "all", "allResolved", "timeout", "delay", "catch", "finally", "fail", "fin", "progress", "done", "nfcall", "nfapply", "nfbind", "denodeify", "nbind", "ncall", "napply", "nbind", "npost", "nsend", "ninvoke", "nodeify"], function(e, t) {
		l.prototype[t] = function() {
			return u[t].apply(u, [this].concat(Z(arguments)))
		}
	}, void 0), l.prototype.toSource = function() {
		return this.toString()
	}, l.prototype.toString = function() {
		return "[object Promise]"
	}, u.nearer = c, u.isPromise = h, u.isPromiseAlike = p, u.isPending = d, u.isFulfilled = v, u.isRejected = m;
	var ft = [],
		lt = [],
		ct;
	typeof process != "undefined" && process.on && process.on("exit", function() {
		for (var e = 0; e < lt.length; e++) {
			var t = lt[e];
			t && typeof t.stack != "undefined" ? console.warn("Unhandled rejected promise:", t.stack) : console.warn("Unhandled rejected promise (no stack):", t)
		}
	}), u.reject = y, u.fulfill = b, u.resolve = w, u.master = S, u.when = x, u.spread = T, u.async = N, u["return"] = C, u.promised = k, u.dispatch = L, u.dispatcher = A, u.get = A("get"), u.set = A("set"), u["delete"] = u.del = A("delete");
	var ht = u.post = A("post");
	u.send = O, u.invoke = O, u.fapply = M, u["try"] = _, u.fcall = _, u.fbind = D, u.keys = A("keys"), u.all = P, u.allResolved = H, u["catch"] = u.fail = B, u.progress = j, u["finally"] = u.fin = F, u.done = I, u.timeout = q, u.delay = R, u.nfapply = U, u.nfcall = z, u.nfbind = W, u.denodeify = u.nfbind, u.nbind = X, u.npost = V, u.nsend = $, u.ninvoke = u.nsend, u.nodeify = J;
	var pt = o();
	return u
}), montageDefine("0fe37da", "package.json", {
	exports: {
		name: "montage",
		version: "0.12.6",
		hash: "0fe37da",
		...
		mappings: {
			...
			collections: {
				name: "collections",
				hash: "6828b8e",
				location: "../collections@6828b8e/"
			}
		},
		production: !0,
		useScriptInjection: !0
	}
}), montageDefine("6828b8e", "package.json", {
	exports: {
		name: "collections",
		version: "0.1.17",
		hash: "6828b8e",
...
}), montageDefine("99ed6d0", "package.json", {
	exports: {
		name: "q",
		version: "0.9.2",
		hash: "99ed6d0",
...
}), montageDefine("1c0e374", "package.json", {
	exports: {
		name: "popcorn",
		version: "0.0.2",
		hash: "1c0e374",
		...
		mappings: {
			montage: {
				name: "montage",
				hash: "0fe37da",
				location: "packages/montage@0fe37da/"
			}
		},
		production: !0,
		useScriptInjection: !0
	}
}), montageDefine("0fe37da", "core/event/event-manager", {
		...
		if (typeof window != "undefined") {
			...
			o.defineSerializationUnit("listeners", function(e, t) {
				...
				for (var f in n.registeredEventListeners) {
					...
					if (o)
						for (var l in o.listeners) u = o.listeners[l], i.push({
							type: f,
						...
						value: function(e) {
							...
							if (e.HTMLDivElement.prototype.addEventListener !== e.Element.prototype.nativeAddEventListener && e.HTMLElement && "addEventListener" in e.HTMLElement.prototype && e.Components && e.Components.interfaces) {
								...
								for (n in Components.interfaces)
									if (n.match(/^nsIDOMHTML\w*Element$/)) {
										n = n.replace(/^nsIDOM/, "");
						...
						value: function(e) {
							...
							do {
								if (t) {
									...
									if (s)
										if (!s._preparedForActivationEvents) s._prepareForActivationEvents(), s._preparedForActivationEvents = !0;
										else
									if (s._preparedForActivationEvents) return
								}
								n = t;
								switch (t) {
									case r:
...
}), montageDefine("0fe37da", "core/deserializer", {
...
}), montageDefine("0fe37da", "core/event/binding", {
	...
	factory: function(e, t, n) {
		...
		Object.defineProperty(Object, "defineBinding", {
			value: function(e, t, n) {
				...
				if ((n.__proto__ || Object.getPrototypeOf(n)) !== p)
					if ("__proto__" in n) n.__proto__ = p;
					else {
						var c = n;
						n = Object.create(p);
			...
			value: function(e) {
				var t = e._bindingDescriptors;
				if (t)
					for (var n in t) t.hasOwnProperty(n) && Object.deleteBinding(e, n)
			}
			...
			value: function(e, t) {
				var n = e._bindingDescriptors,
					r;
				if (n)
					for (var i in n) n.hasOwnProperty(i) && (r = n[i].bindingListener, r && (!t || !r.bindingOriginValueDeferred) && r.applyDeferredValues())
			}
...
}), montageDefine("0fe37da", "core/uuid", {
	dependencies: [],
	factory: function(e, t, n) {
		function r(e) {
			var t = i,
...
}), montageDefine("0fe37da", "core/event/mutable-event", {
...
}), montageDefine("0fe37da", "core/serializer", {
		...
		var f = i.create(i, {
			...
			serialize: {
				value: function(t) {
					...
					for (i in t)
						if (t[i] != null || s) r = this._serializeValue(t[i], null, 2), i in this._serializedObjects || (this._serializedObjects[i] = {
							value: r
						});
...
}), montageDefine("0fe37da", "core/core", {
	dependencies: ["collections/shim", "core/shim/object", "core/shim/array", "core/shim/string", "core/extras/object", "core/extras/array", "core/extras/date", "core/extras/element", "core/extras/function", "core/extras/regexp", "core/extras/string", "core/uuid", "core/promise"],
	factory: function(e, t, n) {
		function r(e, t) {
			var n = s + t + i;
		...
		var E = e("core/uuid");
		typeof window != "undefined" && (window.uuid = E.generate());
		...
		Object.defineProperty(Object.prototype, "_uuid", {
		...
		}), t._blueprintModuleIdDescriptor = {
			serializable: !1,
			enumerable: !1,
			get: function() {
				var e = d.getInfoForObject(this),
					t = e && !e.isInstance ? this : Object.getPrototypeOf(this);
				if (!Object.getOwnPropertyDescriptor(t, "_blueprintModuleId") || !t._blueprintModuleId) {
					e = d.getInfoForObject(t);
					var n = e.moduleId,
						r = n.lastIndexOf("/"),
						i = n.lastIndexOf(".");
					r = r === -1 ? 0 : r + 1, i = i === -1 ? n.length : i, i = i < r ? n.length : i, d.defineProperty(t, "_blueprintModuleId", {
						enumerable: !1,
						value: n.slice(0, i) + "-blueprint.json"
					})
				}
				return t._blueprintModuleId
			}
		}, t._blueprintDescriptor = {
			serializable: !1,
			enumerable: !1,
			get: function() {
				var n = d.getInfoForObject(this),
					r = n && !n.isInstance ? this : Object.getPrototypeOf(this);
				if (!Object.getOwnPropertyDescriptor(r, "_blueprint") || !r._blueprint) {
					var i = r.blueprintModuleId;
					if (i === "") throw new TypeError("Blueprint moduleId undefined for the module '" + JSON.stringify(r) + "'");
					t._blueprintDescriptor.BlueprintModulePromise || (t._blueprintDescriptor.BlueprintModulePromise = e.async("core/meta/blueprint").get("Blueprint")), d.defineProperty(r, "_blueprint", {
						enumerable: !1,
						value: t._blueprintDescriptor.BlueprintModulePromise.then(function(e) {
							var t = d.getInfoForObject(r);
							return e.getBlueprintWithModuleId(i, t.require).then(null, function() {
								var t = e.createDefaultBlueprintForObject(r);
								return t.blueprintInstanceModuleId = i, t
							})
						})
					})
				}
			...
			set: function(t) {
				var n = d.getInfoForObject(this),
					r, i = n && !n.isInstance ? this : Object.getPrototypeOf(this);
				if (t === null) r = null;
				else {
					if (typeof t.then == "function") throw new TypeError("Object blueprint should not be a promise '" + JSON.stringify(t) + "'");
					t.blueprintInstanceModuleId = i.blueprintModuleId, r = e("core/promise").Promise.resolve(t)
				}
				d.defineProperty(i, "_blueprint", {
					enumerable: !1,
					value: r
				})
			}
...
}), montageDefine("0fe37da", "core/logger", {
	dependencies: ["montage"],
	factory: function(e, t, n) {
		var r = e("montage").Montage,
			i, s, o, u, a, f, l, c, h;
...
}), montageDefine("0fe37da", "core/change-notification", {
	...
	factory: function(e, t, n) {
		...
		Object.defineProperty(Array.prototype, "addPropertyChangeListener", {
			...
			value: function(e, t, n, r, i) {
				...
				if (r != 0)
					for (; t < i; t++) s = c.getPropertyChangeDescriptor(this, t), s && (o = this[t], u = this[t - r], o !== u && (e.index = t, e.propertyPath = String(t), e.minus = o, s.handleWillChange(e)))
			}
			...
			value: function(e, t, n, r, i) {
				...
				if (r != 0)
					for (; t < i; t++) s = c.getPropertyChangeDescriptor(this, t), s && (o = this[t + r], u = this[t], o !== u && (e.index = t, e.propertyPath = String(t), e.minus = o, e.plus = u, s.handleChange(e)))
			}
...
}), montageDefine("0fe37da", "core/shim/object", {
	dependencies: [],
	factory: function(e, t, n) {
...
}), montageDefine("0fe37da", "core/shim/array", {
	dependencies: [],
	factory: function(e, t, n) {
...
}), montageDefine("0fe37da", "core/shim/string", {
	dependencies: [],
	factory: function(e, t, n) {
...
}), montageDefine("0fe37da", "core/extras/object", {
	...
	factory: function(e, t, n) {
		...
		Object.defineProperty(Object.prototype, "getProperty", {
			...
			value: function(e, t) {
				var n = e,
					r;
				do r = Object.getOwnPropertyDescriptor(n, t); while (!r && (n = n.__proto__ || Object.getPrototypeOf(n)));
				return r
			},
			writable: !0,
			configurable: !0
...
}), montageDefine("0fe37da", "core/extras/array", {
	dependencies: [],
	factory: function(e, t, n) {
		var r = /^[0-9]+$/;
		Object.defineProperty(Array.prototype, "getProperty", {
			value: function(e, t, n, i, s) {
				...
				if (v) i && i(this, v + "()", null, null, null), m = e.substring(a + 1, f), o = this[v](m, i);
					...
					if (n)
						while ((h = this[p]) != null) o[p] = h.getProperty(e, t, n, i, s), p++;
					else {
...
}), montageDefine("0fe37da", "core/extras/date", {
	dependencies: [],
	factory: function(e, t, n) {
...
}), montageDefine("0fe37da", "core/extras/element", {
	dependencies: [],
	factory: function(e, t, n) {
...
}), montageDefine("0fe37da", "core/extras/function", {
	dependencies: ["./object"],
	factory: function(e, t, n) {
...
}), montageDefine("0fe37da", "core/extras/regexp", {
	dependencies: [],
	factory: function(e, t, n) {
		if (!RegExp.isRegExp) {
...
}), montageDefine("0fe37da", "core/extras/string", {
	dependencies: [],
	factory: function(e, t, n) {
...
}), montageDefine("0fe37da", "ui/loader.reel/loader", {
	dependencies: ["core/core", "ui/component", "core/logger"],
	factory: function(e, t, n) {
		var r = e("core/core").Montage,
			i = e("ui/component").Component,
			s = e("core/logger").logger("loader"),
			o = "_montageStartBootstrappingTimeout",
			u = "montage-app-bootstrapper",
			a = "montage-app-loader",
			f = "montage-app-bootstrapping",
			l = "montage-app-loading",
			c = "montage-app-loaded",
			h = 0,
			p = 1,
			d = 2,
			v = 3;
		t.Loader = r.create(i, {
			...
			initializedModules: {
				...
				enumerable: !1,
				get: function() {
					return !this._initializedModules || this.includeFrameworkModules ? this._initializedModules : this._initializedModules.slice(this._frameworkModuleCount - 1)
				},
				set: function(e) {
					this._initializedModules = e
				}
			},
			_requiredModules: {
				value: null
			...
			requiredModules: {
				...
				enumerable: !1,
				get: function() {
					return !this._requiredModules || this.includeFrameworkModules ? this._requiredModules : this._requiredModules.slice(this._frameworkModuleCount - 1)
				},
				set: function(e) {
					this._requiredModules = e
				}
			},
			_currentStage: {
				value: h
			...
			currentStage: {
				...
				set: function(e) {
					if (e === this._currentStage) return;
					s.isDebug && s.debug(this, "CURRENT STAGE: " + e), this._currentStage = e, this.needsDraw = !0
				}
			},
			_readyToShowLoader: {
				value: !1
			...
			readyToShowLoader: {
				...
				set: function(e) {
					if (e !== this._readyToShowLoader) return;
					this._readyToShowLoader = e, this.needsDraw = !0
				}
			},
			...
			templateDidLoad: {
				value: function() {
					s.isDebug && s.debug(this, "templateDidLoad"), this.element || (this.element = document.documentElement, this.attachToParentComponent()), this.readyToShowLoader = !0;
					var e = document._montageTiming,
						t, n = this;
					e.bootstrappingStartTime ? (s.isDebug && s.debug(this, "had already started bootstrapping"), this.currentStage = p, e.bootstrappingEndTime = Date.now(), t = this.minimumBootstrappingDuration - (e.bootstrappingEndTime - e.bootstrappingStartTime), t > 0 ? (s.isDebug && s.debug(this, "still need to show bootstrapper for another " + t + "ms"), this._showLoadingTimeout = setTimeout(function() {
						n._revealLoader()
					}, t)) : this._revealLoader()) : (s.isDebug && s.debug(this, "bootstrapping has not started yet…"), this._loadMainComponent())
				}
			},
			_revealLoader: {
				value: function() {
					s.isDebug && s.debug(this, "_revealLoader"), this.currentStage = d, document._montageTiming.loadingStartTime = Date.now();
					var e, t = document.getElementById(a),
						n, r, i;
					if (t) {
						n = t.children;
						for (e = 0; r = n[e]; e++)
							if (i = r.controller) i.attachToParentComponent(), i.needsDraw = !0
					}
				}
			},
			_revealMainComponent: {
				value: function() {
					s.isDebug && s.debug(this, "_revealMainComponent"), this.currentStage = v
				}
			},
			_loadMainComponent: {
				value: function() {
					s.isDebug && s.debug(this, "_loadMainComponent"), this.isLoadingMainComponent = !0;
					var e = this;
					window.require.async(this.mainModule).then(function(t) {
						return e._mainLoadedCallback(t)
					}).done()
				}
			},
			_mainLoadedCallback: {
				value: function(e) {
					s.isDebug && s.debug(this, "_mainLoadedCallback"), this._mainComponent = e[this.mainName].create(), this.childComponents.push(this._mainComponent), this._mainComponent.setElementWithParentComponent(document.createElement("div"), this), this._mainComponent.needsDraw = !0
				}
			},
			childComponentWillPrepareForDraw: {
				value: function(e) {
					var t = this,
						n;
					if (e === this._mainComponent) {
						s.isDebug && s.debug(this, "main preparing to draw"), this.isLoadingMainComponent = !1, this._contentToRemove = document.createRange(), n = this.element === document.documentElement ? document.body : this.element, this._contentToRemove.selectNodeContents(n), this.childComponents = [this._mainComponent], n.appendChild(this._mainComponent.element);
						var r = document[o],
							i = document._montageTiming,
							u, a;
						i.bootstrappingStartTime ? i.bootstrappingStartTime && !i.loadingStartTime ? (clearTimeout(this._showLoadingTimeout), this._showLoadingTimeout = null, i.bootstrappingEndTime = Date.now(), (u = this.minimumBootstrappingDuration - (i.bootstrappingEndTime - i.bootstrappingStartTime)) > 0 ? (s.isDebug && s.debug(this, "show bootstrapper for another " + u + "ms"), this._showMainComponentTimeout = setTimeout(function() {
							s.isDebug && s.debug(this, "ok, shown bootstrapper long enough"), t._revealMainComponent()
						}, u)) : setTimeout(function() {
							s.isDebug && s.debug(this, "ok, showing bootstrapper now"), t._revealMainComponent()
						}, 0)) : i.loadingStartTime && (i.loadingEndTime = Date.now(), (a = this.minimumLoadingDuration - (i.loadingEndTime - i.loadingStartTime)) > 0 ? (s.isDebug && s.debug(this, "show loader for another " + a + "ms"), this._showMainComponentTimeout = setTimeout(function() {
							s.isDebug && s.debug(this, "ok, shown loader long enough"), t._revealMainComponent()
						}, a)) : this._revealMainComponent()) : (s.isDebug && s.debug(this, "bootstrapper never shown"), clearTimeout(r), r = null, this._revealMainComponent())
					}
				}
			},
			removeContentOnLoad: {
			...
			removeContent: {
				value: function() {
					this._forceContentRemoval = !0, this.needsDraw = !0
				}
			},
			draw: {
				value: function() {
					!this.readyToShowMainComponent && !this.isLoadingMainComponent && (s.isDebug && s.debug(this, "draw; start loading main component"), this._loadMainComponent());
					if (d === this.currentStage) this.element.classList.remove(f), this.element.classList.add(l);
					else if (v === this.currentStage && this._contentToRemove) {
						this.element.classList.remove(f), this.element.classList.remove(l);
						if (this.removeContentOnLoad || this._forceContentRemoval) this._contentToRemove.extractContents(), this._contentToRemove.detach(), this._contentToRemove = null;
...
}), montageDefine("0fe37da", "ui/component", {
		...
		var r = e("montage").Montage,
			...
			l = t.Component = r.create(r, {
				...
				querySelectorComponent: {
					value: function(e) {
						...
						if (i) {
							...
							for (var f = 0, l; l = n[f]; f++)
								if (o === r.getInfoForObject(l).label) return u ? l.querySelectorComponent(u) : l; return null
					}
				},
				querySelectorAllComponent: {
					value: function(e, t) {
						...
						if (s) {
							...
							for (var l = 0, c; c = i[l]; l++) u === r.getInfoForObject(c).label && (!t || t === c.ownerComponent) && (a ? f = f.concat(c.querySelectorAllComponent(a, t)) : f.push(c));
						return f
					}
				},
				template: {
				...
				_deserializedFromTemplate: {
					value: function(e) {
						this.ownerComponent || (l.isPrototypeOf(e) ? this.ownerComponent = e : this.ownerComponent = this.rootComponent)
					}
				},
				blueprintModuleId: {
					serializable: !1,
					enumerable: !1,
					get: function() {
						var e = r.getInfoForObject(this),
							t = e && !e.isInstance ? this : Object.getPrototypeOf(this);
						if (!Object.getOwnPropertyDescriptor(t, "_blueprintModuleId") || !t._blueprintModuleId) {
							e = r.getInfoForObject(t);
							var n = e.moduleId,
								i = n.lastIndexOf("/"),
								s = n.lastIndexOf(".");
							i = i === -1 ? 0 : i + 1, s = s === -1 ? n.length : s, s = s < i ? n.length : s;
							var o;
							s < n.length && n.slice(s, n.length) == ".reel" ? o = n + "/" + n.slice(i, s) + "-blueprint.json" : o = n.slice(0, s) + "-blueprint.json", r.defineProperty(t, "_blueprintModuleId", {
								value: o
							})
						}
						return t._blueprintModuleId
				...
				gateDidBecomeTrue: {
					value: function(e) {
						e == this._canDrawGate ? this._canDraw = !0 : e == this._blockDrawGate && (c.componentBlockDraw(this), this._prepareCanDraw())
					},
					enumerable: !1
				},
				_canDrawGate: {
				...
				_drawIfNeeded: {
					...
					value: function(e) {
						var t, n, r, i;
						this._treeLevel = e, this.needsDraw && !this._addedToDrawCycle && c.addToDrawCycle(this), a.isDebug && a.debug(this, "drawList: " + (this._drawList || []).length + " of " + this.childComponents.length);
					...
					value: function() {
						...
						if (e || this._shouldClearDomContentOnNextDraw) {
							...
							if (e instanceof Element) n.appendChild(e);
								...
								for (var r = 0, i; i = e[r]; r++) n.appendChild(i);
				...
				removeComposer: {
					value: function(e) {
						...
						for (t = 0; t < n; t++)
							if (this.composerList[t].uuid === e.uuid) {
				...
				waitForLocalizerMessages: {
					...
					set: function(e) {
						if (this._waitForLocalizerMessages !== e)
							if (e === !0 && !this.localizer.messages) {
				...
				_draw: {
					value: function() {
						var e = this.element,
							t;
						for (var n in this._elementAttributeValues)
							if (this._elementAttributeValues.hasOwnProperty(n)) {
								var r = this[n];
									...
									if (a.isDebug) {
										...
										if (e._oldSource && n !== e._oldSource) {
											...
											for (var s = 0; s < i.n.length; s++)
												if (i.n[s].text == null) r.push("+ " + i.n[s]);
												else
													for (var o = i.n[s].row + 1; o < i.o.length && i.o[o].text == null; o++) r.push("- " + i.o[o]);
											console.warn(r.join("\n"))
										}
...
}), montageDefine("0fe37da", "ui/template", {
			...
			a, f = t.Template = r.create(r, {
				...
				_extendsTemplateWithInstances: {
					value: function(e, t, n, r) {
						function i(e, t, n) {
							...
							i.removeChild(t);
							if (r)
								for (var u = 0, a = s.length; u < a; u++) i.insertBefore(s[0], r);
							else
								for (var u = 0, a = s.length; u < a; u++) i.appendChild(s[0]);
				...
				insertStylesInDocumentIfNeeded: {
					value: function(e) {
						...
						for (var d = 0, v; v = f[d]; d++)
							if (p = v.getAttribute("href")) {
...
}), montageDefine("0fe37da", "core/gate", {
	dependencies: ["montage", "core/logger"],
	factory: function(e, t, n) {
		var r = e("montage").Montage,
...
}), montageDefine("0fe37da", "ui/application", {
...
}), montageDefine("0fe37da", "ui/montage-window", {
	dependencies: ["montage"],
	factory: function(e, t, n) {
		var r = e("montage").Montage,
...
}), montageDefine("0fe37da", "core/geometry/point", {
	dependencies: ["montage"],
	factory: function(e, t, n) {
		var r = e("montage").Montage;
		t.Point = r.create(r, {
...
}), montageDefine("6828b8e", "shim", {
	dependencies: ["./shim-array", "./shim-object", "./shim-function", "./shim-regexp"],
	factory: function(e, t, n) {
		var r = e("./shim-array"),
			i = e("./shim-object"),
			s = e("./shim-function"),
...
}), montageDefine("6828b8e", "weak-map", {
	dependencies: [],
	factory: function(e, t, n) {
		"use strict";
...
}), montageDefine("6828b8e", "shim-array", {
	...
	factory: function(e, t, n) {
		...
		n.exports = Array, Array.empty = [], Object.freeze && Object.freeze(Array.empty), Array.from = function(e) {
			...
			for (var e in this)
				if (Object.owns(this, e)) return this[e]
		}), r("clear", function() {
...
}), montageDefine("6828b8e", "shim-object", {
	...
	factory: function(e, t, n) {
		...
		Object.owns = function(e, t) {
			...
			return Object.can(t, "forEach") ? typeof t.keys == "function" ? t.forEach(function(t, n) {
				e[n] = t
			...
			var e = {};
			for (var t = 0; t < arguments.length; t++) Object.addEach(e, arguments[t]);
			return e
		}, Object.from = Object.concat, Object.is = function(e, t) {
			...
			if (Object.isObject(e)) {
				if (!n.has(e))
					if (Object.can(e, "clone")) n.set(e, e.clone(t, n));
					else {
...
}), montageDefine("6828b8e", "shim-function", {
	dependencies: [],
	factory: function(e, t, n) {
		n.exports = Function, Function.noop = function() {}, Function.identity = function(e) {
			...
			return n.compare = t, n.by = e, n
		}, Function.get = function(e) {
			return function(t) {
				return Object.get(t, e)
			}
		}
	}
}), montageDefine("6828b8e", "shim-regexp", {
	dependencies: [],
	factory: function(e, t, n) {
		if (!RegExp.escape) {
			var r = /[-[\]{}()*+?.\\^$|,#\s]/g;
...
}), montageDefine("6828b8e", "generic-collection", {
	dependencies: ["./shim-array"],
	factory: function(e, t, n) {
		"use strict";
		...
		n.exports = r, r.prototype.addEach = function(e) {
			if (e && Object(e) === e)
				if (typeof e.forEach == "function") e.forEach(this.add, this);
				else
			...
			return this
		}, r.prototype.deleteEach = function(e, t) {
		...
		}, r.prototype.enumerate = function(e) {
			e == null && (e = 0);
			var t = [];
			return this.reduce(function(n, r) {
				t.push([e++, r])
			}, undefined), t
		}, r.prototype.group = function(e, t, n) {
			n = n || Object.equals;
			var r = [],
				i = [];
			return this.forEach(function(s, o, u) {
				var o = e.call(t, s, o, u),
					a = i.indexOf(o, n),
					f;
				a === -1 ? (f = [], r.push([o, f]), i.push(o)) : f = r[a][1], f.push(s)
			}), r
			...
			e = e || this.contentCompare || Object.compare;
			var t = !0;
			return this.reduce(function(n, r) {
			...
			return e.unshift(this), Array.unzip(e)
...
}), montageDefine("6828b8e", "generic-order", {
	dependencies: ["./shim-object"],
	factory: function(e, t, n) {
		console.log("line 7995");
